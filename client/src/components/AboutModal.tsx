  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4 sm:p-6 lg:p-8">
      ...
      <div className="relative w-full max-w-2xl bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col max-h-[90vh] z-10 animate-fadeIn">
        ...
        {/* Header with WSP background gradient */}
        <div className="p-6 sm:p-8 bg-gradient-to-br from-slate-950 via-slate-900 to-[#2c1212] text-white relative overflow-hidden border-b border-slate-800">
          <div className="absolute -right-16 -bottom-16 w-48 h-48 bg-[#F1503C]/15 rounded-full blur-2xl pointer-events-none" />
          <div className="absolute -left-16 -top-16 w-48 h-48 bg-slate-700/20 rounded-full blur-2xl pointer-events-none" />

          <div className="flex items-start justify-between relative z-10">
            <div className="flex items-center gap-3.5">
              <WspLogo size="lg" variant="icon" />
              <div>
                <div className="flex items-center gap-2">
                  <h2 className="text-xl sm:text-2xl font-black tracking-tight text-white">
                    <span className="text-[#F1503C]">WSP</span> TED Bevakare
                  </h2>
                  <span className="text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded-full bg-[#F1503C]/20 text-red-300 border border-[#F1503C]/40">
                    v1.0
                  </span>
                </div>
                <p className="text-xs text-slate-300 font-medium">Tenders Electronic Daily Monitor • WSP Sverige</p>
              </div>
            </div>
